...
/// <summary>
/// Implement this interface to enable logging extensions which hook onto Microsofts logging abstractions.
/// </summary>
...
/// and creates a service-locator mess all over your code as every and each class would need to do this just to be able to log.
/// 
/// Instead, I encapsulate and enclose that tumor of a pattern inside ILogging interface which resolves loggers for you through 
/// extensions methods. Just have your class 'implement' this interface (it is empty) and use the extension methods to log. 
/// The intended Microsoft's logging pattern will induce stage III cancer in your code before you know it so if you want logging,
...
public static class LoggingExtensions
{
    ...
    /// <summary>
    /// Tries to get or create ILogger for the given type, may return null (exceptions are logged to Debug).
    /// </summary>
    public static ILogger GetLogger(this Type loggingType)
    {
