...
public static class StringExtensions
{
    ...
    /// </summary>
    public static string CompactWhitespace(this string s)
    {
    ...
    /// and all whitespaces are replaced to space char (so we have uniform space separator). And it is fast.
    /// </summary>
    public static void CompactWhitespace(this StringBuilder sb)
    {
        if ((sb?.Length ?? 0) == 0)
            return;
    ...
    public static string ToCsv(this IEnumerable<string> e, bool space = false) => JoinString(e, space ? ", " : ",");
